...
//	MAGIC_PURPLE_WALL,							// 72
 ...
 // 질드레 스킬
	...
	SKILL_ILLUSION_INVERSION,	//379  왜꼭뼙얾
	...
	SKILL_OUSTERS_WATER_RAPID_FREEZE,	//섐떨깥뻔
	///////////////////
	SKILL_UNKOWN1,
	SKILL_UNKOWN2,
	SKILL_UNKOWN3,
...
//	RESULT_MAGIC_PURPLE_WALL,							// 72
    ...
    RESULT_SKILL_GRENADE_ATTACK, //by viva ousters(problem)(RESULT_SKILL_GUN_SHOT_GUIDANCE)                     // 357  // 몬스터용
	...
	RESULT_SKILL_ILLUSION_INVERSION,				// 379  왜꼭뼙얾
	RESULT_SKILL_HEAVEN_GROUND,						// 380  天神降临
	// 恐怖幻觉分身单个显示效果
	RESULT_TEMP_SKILL_ILLUSION_INVERSION,			// 
	// 침쥣세콘
	RESULT_SKILL_DUMMY_DRAKE,        // 382 돠잉옹웨잔(삽)
	RESULT_SKILL_HYDRO_CONVERGENCE,  // 383 릿북彊좟(彊)
	RESULT_SKILL_SUMMON_CLAY,		 // 384 瀾皐梁뻥(皐)
	RESULT_SKILL_HETER_CHAKRAM,			 // 385 謳꼈적샘凜(濫却)
#endif
...
// add by Coffee 2007-3-17
	...
	SKILL_CLIENT_BLOOD_CURSE, //俱沂뱁劤세콘(沂裂罹麓)
#endif
// end
