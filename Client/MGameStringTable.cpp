...
InitGameStringTable()
{
	...
	(*g_pGameStringTable)[STRING_MESSAGE_CANNOT_SILVERING] = "꼇콘뗬陵。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_TRADE_REJECTED] = "뚤렘앳없슥弄。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_SKILL_EXCEED_LEVEL] = "세콘된섬튤멕。";
	...
	(*g_pGameStringTable)[STRING_STATUS_STR_1] = "제좆(STR)긴냥죄%d。";
	(*g_pGameStringTable)[STRING_STATUS_STR_2] = "제좆(STR)긴냥죄%d。";
	...
	(*g_pGameStringTable)[STRING_STATUS_LEVEL] = "된섬긴냥죄%d(Level)。";
	...
	(*g_pGameStringTable)[STRING_ERROR_ALREADY_CONNECTED] = "綠젯쌈。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_ITEM_BROKEN] = "돛야뻐죄。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_CAN_REGISTER_NAME] = "옵鹿되쩌。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLICK_TRADE_ITEM] = "헝듐샌狼슥弄돨돛야。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLICK_SILVERING_ITEM] = "헝듐샌狼뗬陵돨돛야。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_THROW_MONEY] = "휀풀";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_ITEM_DESCRIPTION] = "查看道具说明";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DEPOSIT_MONEY] = "닸풀";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_JOIN] = "속흙";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MENU] = "꽉데(Menu)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EXP] = "经验值(Exp)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM] = "무삔(Team)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MESSAGE] = "헙괩(Message)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HELP] = "帮助 (Help)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_INVENTORY] = "돛야눗왯(Inventory)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GEAR_WINDOW] = "装备窗口(Gear Window)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_INFO_WINDOW] = "헙괩눗왯(Info Window)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO] = "무삔헙괩(Team Info)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN] = "무삔";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_INFO] = "무삔헙괩(Guild Info)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_ARMOR] = "누원솖";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_SHIELD] = "덖뜀탬";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_WEAPON] = "拿武器";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_GLOVE] = "戴手套";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_BELT] = "덖藍덖";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_TROUSER] = "穿裤子";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_BRACELET] = "戴手镯";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_RING] = "덖썰寧";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_SHOES] = "穿鞋";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_VAMPIRE_COAT] = "누擄륩";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_EARRING] = "덖랐뻔 ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_WHISPER_CHATTING] = "픔픔뺐(W)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_WHISPER_CHATTING] = "꿴였픔픔뺐";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_SHOW_WHISPER_CHATTING] = "꼇였픔픔뺐";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SECEDE] = "썩뇜";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_MAGIC_INFO_WINDOW] = "꿴였침랬헙괩눗왯";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLOSE_INVENTORY_WINDOW] = "밑균돛야눗왯";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLOSE_MAGIC_INFO_WINDOW] = "밑균침랬헙괩눗왯";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_STR] = "제좆 ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DEX] = "츌쌥 ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_STR] = "제좆";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_STR_PURE] = "늉   제   좆 :%d";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DEX_PURE] = "늉   츌   쌥 :%d";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SPEED_SLOW] = "뻠찹";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SPEED_NORMAL] = "一般";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SPEED_FAST] = "우";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ATTACK_SPEED] = "攻击速度: %s[%d]";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PASSIVE] = "굳땡";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HAN_PASSIVE] = "굳땡";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HPBAR_LEVEL_DESCRIPTION] = "된섬 :%d";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HPBAR_EXP_DESCRIPTION] = "经验值 (EXP):%s/%s (?? ???:%s)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HPBAR_MP_DESCRIPTION] = "침랬제 (MP):%d/%d";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLOSE_WINDOW] = "밑균눗왯";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REGIST] = "되쩌";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_GRADE_SUB_MASTER] = "릴삔낀";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_GRADE_WAIT] = "等待登录人员";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_GRADE_MEMBER] = "会员";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_GRADE] = "된섬(Grade) : %s";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_REG_FEE] = "속흙롤 (Reg. Fee) : $%s";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_RANKING] = "탤츰(Ranking) : %d";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_TEAM_NAME] = "무삔츰(Team Name) : %s";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_CLAN_NAME] = "무삔츰 (Clan Name) : %s";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_REGISTRATION_FEE] = "속흙롤 (Registration Fee) : $%s";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_JOIN_DENY] = "앳없속흙";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CANCEL] = "혤句";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_LIMBOLAIR] = "주괜넒";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ESLANIA] = "냘";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TIMORE] = "뒝칭랑빤.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACCELERATOR_SKILL] = "세콘";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACCELERATOR_INVENTORY] = "돛야";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACCELERATOR_QUICKITEM_SLOT] = "우쌥돛야으";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACCELERATOR_WHISPER] = "픔픔뺐";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ITEM_CLASS_SWORD] = "숲(SWORD)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ITEM_CLASS_BLADE] = "독 (BLADE)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ITEM_CLASS_MINE] = "뒈잉 (MINE)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ITEM_CLASS_BOMB] = "텔뎐 (BOMB)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_MP] = "침랬제 (MP) : ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_NUMBER] = "몸";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_MAGAZINE_COUNT] = "랙";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_TILE_PIECE] = "목";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_LEVEL] = "된섬 ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_PRICE] = "송목: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_SILVERING_PRICE] = "뗬陵송목: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_CHARGE_PRICE] = "념든송목: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_REPAIR_PRICE] = "修理价格: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CONSUME_HP] = "生命力 (HP)消耗量: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CONSUME_MP] = "침랬제 (MP)句봬좆: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUIRE_LEVEL] = "된섬狼헹: ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MOVE] = "盧땡";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CANCEL_MOVE] = "혤句盧땡";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_CANCEL_OK_BUTTON] = "OK굳혤句";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_CANCEL_EXCHANGE] = "슥뻣굳혤句";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_BRING_MONEY] = "退回交易中的金钱";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_EXCHANGE_MONEY] = "풀슥弄";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_EXCHANGE_YOUR_MONEY] = "뚤렘狼슥弄돨쏜풀";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_LEFT_MONEY_AFTER_EXCHANGE] = "슥弄빈돨쏜띨";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_WILL_EXCHANGE_MONEY] = "슥弄쏜띨";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ASK_DIALOG_TRADE_OTHER_PLAYER] = "횅땍狼%s뵨슥弄찐？";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ASK_DIALOG_WAIT_OTHER_PLAYER] = "正在等待%s的应答。";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ASK_DIALOG_CANCEL] = "혤句헝객혤句객큔。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_DIALOG_SILVERING] = "                        뗬陵: %d";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_DIALOG_DEFENSE] = "                        쀼긁쪽: %d";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_DESC_DIALOG_PRICE] = "                        송목 : %s";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FILE_DIALOG_CANCEL] = "혤句깻밑균눗왯";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_BLADE] = "독";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_SWORD] = "숲";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_ENCHANT] = "祝";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_GUN] = "퓜";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_HEAL] = "뿟";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MONSTER_NAME_GOLEMER] = "웨잔";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MONSTER_NAME_DARKSCREAMER] = "붚침";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MONSTER_NAME_REDEYE] = "븐癩";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MONSTER_NAME_CRIMSONSLAUGTHER] = "든얄욺훙";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MONSTER_NAME_HOBBLE] = "붐꺽";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS_VERY_GOOD] = "좁봤";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS_GOOD] = "봤";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS_NORMAL] = "런챈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS_BAD] = "렷끽런챈";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS_OPEN] = "역";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SERVER_STATUS_CLOSE] = "밑";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_CANCEL] = "혤句";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_LEVEL] = "된섬: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_STR_PURE] = "늉제좆: ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_CREATEMSG1] = "객눼쉔객큔숩옵鹿";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_CREATEMSG2] = "建新人物";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHAR_MANAGER_GRADE] = "섬깎 : ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OPTION_MENU_MUSIC_VOLUME] = "교쒼稜있稜좆";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OPTION_MENU_MSG2] = "혤句헝객ESC";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_MARSHAL ] = "쉥엊";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_RITTER] = "랗된켕얽";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_REICHSRITTER] = "랗된켕얽";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_PFALZGRAF] = "힛된껍얽";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_FURST] = "랗된껍얽";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_HERZOG] = "一等伯爵";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_LANDESHER] = "낀일";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLIENT_VERSION] = "경굶";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NETMARBLE_CLIENT_VERSION] = "Netmarble version";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OTHER_INFO_STR_PURE] = "늉제좆: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OTHER_INFO_DEX_PURE] = "纯敏捷性: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OTHER_INFO_INT_PURE] = "늉세콘  : ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OTHER_INFO_TEAM_NAME] = "뚠츰 : ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OTHER_INFO_CLAN_NAME] = "무삔츰 : ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TIP_CHANGE_PICTURE_CLICK_HERE] = "换照片";
	(*g_pGameStringTable)[STRING_MESSAGE_UP_TO_GRADE] = "升级了.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_NAME] = "쌓섬츰냔 : ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_LEVEL] = "쌓섬된섬: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_BLADE2] = "독";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_SWORD2] = "숲";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_ENCHANT2] = "祝福";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_GUN2] = "퓜";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_DISMISS_AFTER_SECOND] = "%d취빈삔굳먀놔혼";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_GRADE1_INFO_WINDOW] = "꿴였쌓섬세콘눗왯。";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_GRADE2_INFO_WINDOW] = "꿴였쌓섬세콘눗왯。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACCELERATOR_GRADE1] = "쌓섬된섬1";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ACCELERATOR_GRADE2] = "쌓섬된섬2";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_REWARD_OK] = "돤돕죄껸낄。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_MIHOLE] = "쵠샅랑";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_KIRO] = "샘쭈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_INI] = "阿伊尼";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_GREGORI] = "목적멕쟁";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_JAVE] = "속른";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_NEMA] = "코쯔";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_AROSA] = "각쭈힉";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_MIHOLE_ENG] = "쵠샅랑";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_KIRO_ENG] = "펜쭤";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_INI_ENG] = "간凜";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_GREGORI_ENG] = "목적멕쟁";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_JAVE_ENG] = "속른";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_NEMA_ENG] = "잉쯔";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_AROSA_ENG] = "각쭈힉";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_BLOOD_BIBLE_STATUS_ATTACK_GUILD] = "묑샌";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_SLAYER] = "훙잚";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_COUPLE_APART_SUCCESS] = "綠잼삯。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_COUPLE] = "헙쩟";
	(*g_pGameStringTable)[STRING_MESSAGE_MOVE_DELAY_SEC] = "%d취빈盧땡.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CAN_REQUITAL_FROM_NPC] = "닒NPC컸쟁옵鹿돤돕껸낄.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_FAIL_INVALID_NPC] = "꼇콘닒맡NPC돤돕껸낄.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ITEM_SHOP] = "듐샌돛야츰냔옵鹿컬윱맡돛야。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPLETE_MERGE_ITEM] = "좃몸돛야냥묘북깻。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CONSUME_EP] = "EP句봬좆: ";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_STONE] = "%s돨쑹쥣섬깎:";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GRADE_GEBURAH] = "멕섬죤훙";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_FIRE] = "삽";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_WATER] = "水";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_EARTH] = "댕뒈";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_WIND] = "루";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_SUM] = "总合";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EP] = "쥣제";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_SHOW_GUILD_CHATTING] = "꼇뀁였무삔뚤뺐";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SHOW_GUILD_CHATTING] = "꿴였무삔뚤뺐";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_CHATTING] = "쏵契무삔뚤뺐";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HPBAR_EP_DESCRIPTION] = "쥣제 (EP):%d/%d";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_LEFT_BONUS_POINT] = "要分配奖励分值。";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD] = "무삔(Guild)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_INFO] = "무삔헙괩 (Guild Info)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_FIRE_DESCRIPTION] = "삽 :%d";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ELEMENTAL_WIND_DESCRIPTION] = "루 :%d";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLOSE_HORN] = "혤句댕뒈쑹쥣돨실。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_OPEN_LAIR] = "綠역%s.";
	(*g_pGameStringTable)[STRING_MESSAGE_CLOSED_LAIR] = "綠밑%s.";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_SUCCESS_CHANGE] = "긴뫘냥묘。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_GET_RIFINIUM] = "鹿삿돤돛야。";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_QUEST_STATUS_ARROW_TILES] = "战略指针";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_QUEST_STATUS_CRAZY_MINE] = "룩욺뒈잉";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_GUILD_REGIST_FAIL_DENY] = "슥弄굳앳없。";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_OUSTERS] = "침쥣";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MUTE] = "굳GM쐐喇";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_GUILD_NAME] = "무삔츰냔: %s";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO_GUILD_INTRODUCTION] = "公会介绍: ";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OTHER_INFO_GUILD_NAME] = "무삔츰냔: ";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_RESURRECT_AFTER_SECONDS] = "%d취빈옵鹿릿삶";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_LEVEL_WAR_ZONE_NAME] = "엥쟁멕%dF";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SWEEPER_BONUS_11] = "홍꼬둬예제+ 7";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLICK_TO_WARP_REGEN_TOWER] = "옵鹿盧땡돕寧땍끝뒈.";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_NEW_PET_LEVEL_1] = "%s돨된섬긴냥죄 %d";
	(*g_pGameStringTable)[STRING_MESSAGE_NEW_PET_LEVEL_2] = "%s돨된섬긴냥죄 %d";
	(*g_pGameStringTable)[STRING_MESSAGE_OPTION_NAME_LUCK_3] = "幸运";
	(*g_pGameStringTable)[STRING_MESSAGE_OPTION_NAME_LUCK_4] = "팠훙";
	(*g_pGameStringTable)[STRING_MESSAGE_OPTION_NAME_ATTR_3] = "솽벎";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_OPTION_ENAME_LUCK_4] = "큰꼽";
	(*g_pGameStringTable)[STRING_MESSAGE_OPTION_ENAME_ATTR_3] = "솽벎";
	(*g_pGameStringTable)[STRING_MESSAGE_OPTION_ENAME_ATTR_4] = "喀嚓";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CAN_PET_REVIVAL] = "옵鹿릿삶。";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_0] = "숲&독";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_1] = "숲";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_2] = "독";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_3] = "퓜";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_13] = "렝뎐擄";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_14] = "下衣";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_15] = "뜀탬";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_16] = "手套";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_17] = "藍던";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_COMPUTER_STRING_22] = "썰寧";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HAN_DOMAIN_BLADE] = "독";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HAN_DOMAIN_SWORD] = "숲";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HAN_DOMAIN_ENCHANT] = "祝福";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HAN_DOMAIN_GUN] = "퓜";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENG_DOMAIN_OUSTERS] = "침쥣";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_QUEST_NPC_SLAYER] = "며쨀껍";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_QUEST_CLEAR] = "쀼혼걸。";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CAN_3RD_ENCHANT_PET] = "옵鹿돤돕3늴콘제";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ITEM_GRADE_DESC] = "된섬";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SMS_FAIL_MAX_NUM_EXCEEDED] = "괏밗뵀쯤낚법";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SMS_WINDOW] = "SMS눗왯(SMS Window)";
	(*g_pGameStringTable)[UI_STRING_HELP_SMS_SEND] = "传送信息.";
	(*g_pGameStringTable)[UI_STRING_HELP_SMS_VIEW_LIST] = "꿴였든뺐뵀쯤.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NAMING_WINDOW] = "켱냔눗왯(NickName Window)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADD_PLAYER_NICKNAME] = "맒속NickName.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SELECT_PLAYER_NICKNAME] = "更改选择的NickName.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NICKNAME_CHANGE_OK] = "NickName綠뫘맣.";
	...
	(*g_pGameStringTable)[UI_STRING_CORE_ZAP_RED] = "침랬묑샌제+%d";
	...
	(*g_pGameStringTable)[UI_STRING_CORE_ZAP_REWARD_ALL_REG] = "홍꼬둬예제+%d(4Set)";
	...
	(*g_pGameStringTable)[UI_STRING_GQUEST_SUCCESS] = "냥묘";
	...
	(*g_pGameStringTable)[UI_STRING_NOTICE_EVENT_GOLD_MEDALS] = "컬돕죄%d뵨쏜탬.";
	...
	(*g_pGameStringTable)[STRING_MESSAGE_SIEGE_POTAL_200] = "盧땡";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_RANK_BONUS_WARRIORS_FIST] = "제좆 (STR) +5";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_RANK_BONUS_POISON_INQUIRY] = "뗀(Poison) ?? +10%";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SIEGE_ATTACK] = "(묑샌렘)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_LIST_GRADE] = "된섬 (GRADE)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_COMMAND_WINDOW] = "무삔츱즈 (Clan Command)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_LIST_WINDOW] = "무삔커쩌 (Clan List)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_WAIT_LIST_WINDOW] = "된덤무삔커쩌 (Wait Clan List)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_UNION_WINDOW] = "무삔젬북 (Clan Union)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_COMMAND_WINDOW] = "무삔츱즈 (Guild Command)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_LIST_WINDOW] = "무삔커쩌 (Guild List)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_WAIT_LIST_WINDOW] = "된덤무삔커쩌 (Wait Guild List)";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_UNION_WINDOW] = "무삔젬북 (Guild Union)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TOTAL_GUILD_ALREADY_IN_UNION] = "綠쒔속흙무삔.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TOTAL_GUILD_MESSAGE_SUCCESS] = "젬북무삔냥묘눼쉔";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ASKING_RECALL] = "狼빌싻%s 찐?";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REQUEST_UNION_ERROR_2] = "綠쒔속흙젬북.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REMOVE_CURSE_2] = "갖";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REMOVE_CURSE_3] = "갖콱";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_REMOVE_CURSE_4] = "갖콱";
	...
	(*g_pGameStringTable)[UI_STRING_POWER_JJANG_NUMBER_1] = "삿혤";
	(*g_pGameStringTable)[UI_STRING_POWER_JJANG_NUMBER_2] = "뵀쯤";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_UTIL] = "묘콘(Utility)";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ALREADY_DISPLAYED] = "綠쒔냈죗돨돛야.";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_SHOULDER] = "쇘솖";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EQUIP_DERMIS] = "충야";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CHINGHO] = "냔뵀";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CAMPAIGN_HELP_UNITS_VAMPIRE] = "陵귑";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ADVANCEMENT_JOB_SOLDER] = "멕섬엊훙";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_RECEIVE_OK] = "컬돕죄Come Back삶땡돛야.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GET_EVENT_ITEM_RECEIVE_ALREADY] = "綠쒔쥴혤Come Back삶땡돛야.";
